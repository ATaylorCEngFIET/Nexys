...
HD_PWD='C:/Users/aptay/Downloads/Nexys-Video-HDMI-master/Nexys-Video-HDMI-master/proj/TEMPLATE.runs/hdmi_auto_rs_w_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_auto_rs_w_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_auto_rs_w_1.tcl
