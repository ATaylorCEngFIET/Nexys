...
HD_PWD='C:/Users/aptay/Downloads/Nexys-Video-HDMI-master/Nexys-Video-HDMI-master/proj/TEMPLATE.runs/hdmi_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_xlconstant_0_0.tcl
